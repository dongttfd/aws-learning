...
- Là cơ chế lưu trữ dạng block, 
- Đơn vị quản lý là các EBS volume,
- Chỉ có thể access khi được gắn vào EC2 instance
- Có thể gắn nhiều volume vào 1 instance
###### tính tiền
- Tính theo dung lượng lưu trữ $/GB/tháng
- Tốc độ đọc ghi IOPS (input/output per second) càng cao càng đắt
